...
public final class UtilJSF implements Serializable {
	...
	public static void addMensagemInfo(final String mensagem) {
		...
		UtilJSF.exibirMensagemJSF(mensagem, FacesMessage.SEVERITY_INFO);
	}
	...
	public static void addMensagemWarn(final String mensagem) {
		...
		UtilJSF.exibirMensagemJSF(mensagem, FacesMessage.SEVERITY_WARN);
	}
	...
	public static void addMensagemError(final String mensagem) {
		...
		UtilJSF.exibirMensagemJSF(mensagem, FacesMessage.SEVERITY_ERROR);
	}
